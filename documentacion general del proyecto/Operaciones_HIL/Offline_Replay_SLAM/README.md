...
| `PLAN_CAPTURA_GROUND_TRUTH_ODOMETRIA.md` | Diseño de captura y validación independiente para trayectoria, drift y estacionariedad. |
| `RUNBOOK_CALIBRATION_GT_MIN_PREFLIGHT.md` | Preflight estructural y GO/NO-GO declarativo para una futura CALIBRATION GT-MIN; no autoriza movimiento. |
