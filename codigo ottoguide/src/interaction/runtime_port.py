...
ERR_TERMINAL_STATE: Final[str] = "ERR_TERMINAL_STATE"
ERR_QUEUE_FULL: Final[str] = "ERR_QUEUE_FULL"
ERR_CLOSING: Final[str] = "ERR_CLOSING"
ERR_EMERGENCY: Final[str] = "ERR_EMERGENCY"
ERR_TASK_SETTLEMENT_TIMEOUT: Final[str] = "ERR_TASK_SETTLEMENT_TIMEOUT"
