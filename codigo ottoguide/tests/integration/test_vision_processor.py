...
_vision_module = sys.modules["src.vision"]
assert Path(_vision_module.__file__).resolve().is_relative_to(PROJECT_ROOT), (
    f"src.vision resolved from unexpected location: {_vision_module.__file__}"
)
