...
```bash
cd /ruta/al/proyecto/OttoGuide-Proyecto_SIP-Grupo6-UADE/codigo ottoguide
...
```bash
cd /home/unitree/OttoGuide-Proyecto_SIP-Grupo6-UADE
python3 -m venv .venv
...
### Verificar unitree_sdk2py en el entorno

```bash
python -c "import unitree_sdk2py; print('OK')"
```

Si la verificación falla, reinstalar extras de hardware en la raíz:
